...
public class CensusAnalyserTest {
    ...
    public void givenIndianCensusData_WithWrongFileDelimeter_ShouldThrowException(){
        try {
            ...
            Assert.assertEquals(CensusAnalyserException.ExceptionType.INVALID_FILE_DATA_TYPE,e.type);
        }
    ...
    public void givenIndianStateCodeCSVFileReturnsCorrectRecords() {
        try {
            CensusAnalyser censusAnalyser = new CensusAnalyser();
            int numOfStateCodes = censusAnalyser.loadIndiaStateCode(INDIA_CENSUS_CSV_FILE_PATH);
